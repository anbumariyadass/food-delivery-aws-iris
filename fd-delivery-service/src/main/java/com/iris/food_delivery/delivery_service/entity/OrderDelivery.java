...
public class OrderDelivery {
    ...
    @Column(name = "dlvry_personal_username")
    private String deliveryPersonalUserName;
	...
	public String getDeliveryPersonalUserName() {
		return deliveryPersonalUserName;
	}

	public void setDeliveryPersonalUserName(String deliveryPersonalUserName) {
		this.deliveryPersonalUserName = deliveryPersonalUserName;
	}
