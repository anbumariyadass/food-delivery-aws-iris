...
public interface OrderDeliveryRepository extends JpaRepository<OrderDelivery, Long> {
    ...
    List<OrderDelivery> findByDeliveryPersonalUserNameOrderByOrderIdDesc(String deliveryPersonalUserName);
    ...
    @Modifying
    @Transactional
    @Query("UPDATE OrderDelivery o SET o.deliveryPersonalUserName = :deliveryPersonalUserName WHERE o.orderId = :orderId")
    int updateDeliveryPersonalUserName(Long orderId, String deliveryPersonalUserName);
