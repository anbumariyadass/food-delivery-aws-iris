...
import com.iris.food_delivery.order_service.client.RestApiClient;
...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse> createOrder(@RequestBody Order order) {
    	order.setCustomerUserName(userService.getLoggedInUser());
        Order createdOrder = orderService.saveOrder(order);
        restApiClient.pushOrderIntoQueue(createdOrder);
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_RESTAURANT', 'ROLE_DELIVERY_PARTNER', 'ROLE_DELIVERY_PERSONAL')")
